...
public class UserBean {
	...
	public UserBean(String id, String nickname, String account, String password, String icon, String email,
			String identity, String followersNum, String followingNum) {
		super();
		this.id = id;
