...
<div class="all">
	...
	<div class="mainpage">
	<div style="width:100%;height:30px;margin-left:30%;"><a class="search_change_button" id="search_by_username"  style="font-size:25px;border: 1px solid #96c2f1;
    background: #eff7ff;padding:0px 20px;">显示按用户搜索</a>
	<a style="font-size:25px;padding:0px 20px;border: 1px solid #96c2f1;
    background: #eff7ff;" id="search_by_bookname" >显示按书名搜索</a></div>
...
function getUrlParam(name) {//封装方法
	...
	window.location.href="search.jsp?"+"keywords="+keywords+"&bookType="+bookType+"&searchType="+searchType+"&page="+page;
