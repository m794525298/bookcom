	...
	<div class="all">
		...
		<div class="book_info">
			...
			<div class="cover">
				...
				<input value="上传图片" type="file" id="file" name="file"  />
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		$('.post_button').click(function() {
		 ...
		 function uploadpost(img) {
				...
				var postID=getUrlParam("postID");
				var url = "js/index_recommend.js";//发布功能 得到success
				...
				$.post(url, args, function(data) {
					alert("上传成功");
					alert(bookTitle+bookType+content+author+$.cookie("userID"));
