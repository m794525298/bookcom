$(function(){
		...
		$("#first_page1").click(function(){
			...
			href="personal_post.jsp?page=1";
			window.location.href=href;
		})
		$("#last_page1").click(function(){
			
			href="personal_post.jsp?page="+storage.getItem('totalPage');
			window.location.href=href;
		})
		$("#previous_page1").click(function(){
			...
			if(Number(storage.getItem('totalPage'))>=page&&page>1){
				page=page-1;
			href="personal_post.jsp?page="+page;}else{href="personal_post.jsp?page="+page;}
			window.location.href=href;
		})
		$("#next_page1").click(function(){
			if(1<=page&&page<Number(storage.getItem('totalPage'))){
				...
				page=page+1;
				href="personal_post.jsp?page="+page;}else{
					
					href="personal_post.jsp?page="+page;}
				window.location.href=href;
		})
